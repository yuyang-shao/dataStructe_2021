...
//
//
//int PathMidNode(mgraph c ,int i,int n,int isdraw)   //i表示全排列矩阵的行数，n代表全排列矩阵的列数
//{
...
//		temp = shortestpath_dij(changzhou,i,rangeArray[m][0],0)+midPath+shortestpath_dij(changzhou,rangeArray[m][n-1],j,0);
//		if(temp<path)
//		{
//			path = temp;
//			road = m;
...
//	outtextxy(20, 280, _T("请键入需新增的边的终点代号："));
//	char s1[10];
